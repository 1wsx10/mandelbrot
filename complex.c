...
void mul_comcom(com *a, com *b, com *ret) {
	...
	long double r1r2 = a->r * b->r;
	long double r1i2 = a->r * b->i;
	long double i1r2 = a->i * b->r;
	long double i1i2 = a->i * b->i * -1;//i^2 = -1
...
void sqr_com(com *a, com *ret) {
	// (r + i)(r + i)
	long double rr = a->r * a->r;
	long double ri = a->r * a->i;
	long double ii = a->i * a->i * -1;//i^2 = -1
